...
#if defined(NDEBUG)
# error "Sakhi cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Sakhi Signed Message:\n";
            ...
            return DoS(100, error("ConnectBlock() : coinstake pays too much(actual=%d vs calculated=%d)", nStakeReward, nCalculatedStakeReward));
                ...
                if (pindex->nHeight > 25) {
                    ...
                    BOOST_FOREACH(const CTxOut& output, vtx[1].vout) {  
                       ...
                       CTxDestination addrsakhi2;
                       ExtractDestination(output.scriptPubKey, addrsakhi2);
                       std::string GetTxAdressFromTransaction = CBitcoinAddress (addrsakhi2).ToString().c_str();
                        ...
                        if (GetTxAdressFromTransaction == "Sk96aKe34Z1tvtf6i9tL2bVqk811F5m5cy") {
                              ...
                              uint64_t nOutputSakhi = output.nValue;

                            if (nOutputSakhi == (nCalculatedStakeReward / 5)) {
...
#ifdef ENABLE_WALLET
// Sakhi: attempt to generate suitable proof-of-stake
