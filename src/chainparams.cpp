...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "yeee harrrr, The revolution of PoW/PoS";
        ...
        CTransaction txNew(1, 1528305090, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1528305090;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 161065;

        //MineGenesis(genesis);

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0xa476df1c24885975eb230daee528a92e2f391f16dfa9ff70b045ce5da1e0ea1b"));
        assert(genesis.hashMerkleRoot == uint256("0xf6fa9e38aa1497570395972da17a82998410db6beed782e1fbfa02e11bd2a85f"));
